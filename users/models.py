...
class Room(models.Model):
    title = models.CharField(max_length=255)
    learning_center = models.ForeignKey(LearningCenter, related_name='rooms', on_delete=models.CASCADE)
...
class TeachGroup(models.Model):
    ...
    room = models.ForeignKey(Room, related_name='group', on_delete=models.CASCADE)
    # teachers = models.ManyToManyField(TeacherProfile, related_name='teachgroup')
